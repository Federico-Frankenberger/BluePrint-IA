...
Registry of project-scoped Claude Code skills for this repo.

| Skill | Path | Trigger |
|---|---|---|
| discovery-agent | `.claude/skills/discovery-agent/SKILL.md` | discovery agent, entrevista de discovery, relevamiento de requisitos, iniciar discovery |
| prd-agent | `.claude/skills/prd-agent/SKILL.md` | prd agent, generar prd, product requirement document, in-scope out-of-scope, iniciar prd |
| requirements-agent | `.claude/skills/requirements-agent/SKILL.md` | requirements agent, generar requisitos, RF RNF, requisitos funcionales, iniciar requirements |
| user-stories-agent | `.claude/skills/user-stories-agent/SKILL.md` | user stories agent, generar historias de usuario, HU, iniciar user stories |
| uml-agent | `.claude/skills/uml-agent/SKILL.md` | uml agent, generar uml, diagrama de casos de uso, diagrama de estados, iniciar uml |
